...
===========================-->
	...
	<div class="sidebar">
		...
		<div class="menu">
			...
			</a> <a href="UploadCrop.jsp"> <i class="fa-solid fa-seedling"></i>

				Upload Crop

			</a> <a href="MyCrops.jsp"> <i class="fa-solid fa-leaf"></i> My Crops

			</a> <a href="CropRequests.jsp"> <i class="fa-solid fa-envelope"></i>

				Crop Requests

			</a> <a href="Profile.jsp"> <i class="fa-solid fa-user"></i> Profile
	...
	<div class="main">
		...
		<div class="header">
			...
			<div>
				...
				<p>Manage your crops and requests efficiently.</p>
			...
			<div class="table-box">
				...
				<div class="table-header">
					...
					<h2>
						...
						<i class="fa-solid fa-leaf"></i> &nbsp; My Crop Listings
					...
					<a href="UploadCrop.jsp">
						...
						<button>
							...
							<i class="fa-solid fa-plus"></i> &nbsp; Upload Crop
				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<button class="view-btn">View Requests</button>
...
===========================-->
		...
		<div class="bottom-section">
			...
			<div class="activity">
				...
				<h2>
					...
					<i class="fa-solid fa-chart-line"></i> Farm Activity
		...
		<footer> © 2026 AgriConnect | Connecting Farmers with Buyers
			🌾 </footer>
