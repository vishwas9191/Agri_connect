...
<body>
	...
	<header>
		...
		<div class="buttons">
			...
			<a href="Login.jsp" class="login"> <i class="fa-regular fa-user"></i>

				&nbsp;Login

			</a> <a href="Register.jsp" class="register"> <i
	...
	<section class="hero">
		...
		<div class="hero-left">
			...
			<h1>
				Connecting <span>Farmers & Buyers</span>
			</h1>

			<p>AgriConnect is a platform that connects farmers directly with
				buyers. Sell fresh crops without middlemen, get better prices and
				build trusted business relationships.</p>

			<div class="hero-buttons">

				<a href="Login.jsp" class="start-btn"> Get Started </a> <a
					href="#about" class="learn-btn"> Learn More </a>
	...
	<section class="why">
		...
		<p class="subtitle">A simple platform that connects farmers
			directly with buyers.</p>
		...
		<div class="why-container">
			...
			<div class="why-card">
				...
				<p>Farmers sell directly to buyers without any middlemen.</p>
			...
			<div class="why-card">
				...
				<p>Farmers receive better prices for their products.</p>
			...
			<div class="why-card">
				...
				<p>Safe and transparent buying and selling experience.</p>
	...
	<section class="how">
		...
		<p class="subtitle">Buy and sell directly in just 5 simple steps.
		</p>
	...
	<footer>
		...
		<div class="footer-container">
			...
			<div class="footer-box">
				...
				<p>Connecting Farmers and Buyers directly without middlemen for
					fair and transparent trade.</p>
		...
		<div class="copyright">© 2026 AgriConnect | All Rights Reserved
